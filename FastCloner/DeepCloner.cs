...
public static class DeepCloner
{
    ...
    /// </summary>
    public static T? DeepClone<T>(T? obj) => DeepClonerGenerator.CloneObject(obj);
    ...
    public static TTo? DeepCloneTo<TFrom, TTo>(TFrom? objFrom, TTo? objTo) where TTo : class, TFrom => (TTo?)DeepClonerGenerator.CloneObjectTo(objFrom, objTo, true);
    ...
    /// <returns>existing filled object</returns>
    /// <remarks>Method is valid only for classes, classes should be descendants in reality, not in declaration</remarks>
    public static TTo? ShallowCloneTo<TFrom, TTo>(TFrom? objFrom, TTo? objTo) where TTo : class, TFrom => (TTo?)DeepClonerGenerator.CloneObjectTo(objFrom, objTo, false);
